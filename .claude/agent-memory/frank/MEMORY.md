...
- [La premisa del ENCARGO también se mide](feedback_la_premisa_del_encargo_tambien_se_mide.md) — «no es simulable» y «necesita dos teléfonos» se caen igual: 13 de 16 el 9-sep. Y el fix tiene que estar DENTRO del build.
