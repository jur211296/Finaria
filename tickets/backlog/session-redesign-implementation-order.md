...
| 11 | `retire-guest-vocabulary-for-session-terms` | glosario y rules; puede ir antes, pero aquí ya no queda copy por escribir | directo |
...
| 13 | `after-session-redesign-review-widgets-siri-applepay-and-web-copy` | solo tiene sentido sobre la app terminada; la parte de web/ficha es de Lola | medir |
